...
If you are trying to scope everything to a specific shard, use Octopus.using instead.
    ...
    module InstanceMethods
      ...
      def init_with(coder)
        ...
        current_shard_value = coder['attributes']['current_shard'].value if coder['attributes'] && coder['attributes']['current_shard'].present? && coder['attributes']['current_shard'].value.present?
